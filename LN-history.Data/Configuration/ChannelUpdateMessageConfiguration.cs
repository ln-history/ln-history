...
public class ChannelUpdateMessageConfiguration : DommelEntityMap<ChannelUpdateMessage>
{
    public ChannelUpdateMessageConfiguration()
    {
        ...
        Map(x => x.FeeProportionalMillionths).ToColumn("fee_propotional_millionth");
